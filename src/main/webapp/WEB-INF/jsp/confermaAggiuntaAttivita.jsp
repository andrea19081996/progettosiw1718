...
<body>
		...
		<div id="header" class="container">
			...
			<div id="menu">
				...
				<ul>
					...
					<li class="active"><a href="/nuovaAttivita">Nuova
							attivita'</a></li>
	...
	<div id="wrapper">
		<div id="three-column" class="container">
			<div class="title">
				<h2>Attivita' aggiunta con successo</h2><br>
						...
						<table>
							<tbody>
								<tr class="row100 body">
									<td class="cell100 column1">${attivita.nome}</td>
									<td class="cell100 column2">${data}</td>
									<td class="cell100 column3">${orario}</td>
								</tr>
							</tbody>
						</table>
					</div>
