			...
			<div class="title">
				...
				<div class="table100 ver3 m-b-110">
						...
						<table>
							<thead>
								<tr class="row100 head">
									...
									<th class="cell100 column4">Orario</th>
								</tr>
							</thead>
						</table>
					</div>
					...
					<div class="table100-body js-pscroll">
						<table>
							<tbody>
								<c:forEach var="temp" items="${attivita}" >
									<tr class="row100 body">
										<td class="cell100 column1"><a href="/centro/attivita/${temp.id}">${temp.id}</a></td>
										<td class="cell100 column2"><a href="/centro/attivita/${temp.id}">${temp.nome}</a></td>
										<td class="cell100 column3"><a href="/centro/attivita/${temp.id}">${temp.data}</a></td>
										<td class="cell100 column4"><a href="/centro/attivita/${temp.id}">${temp.orario}</a></td>
									</tr>
								</c:forEach>
							</tbody>
						</table>
